...
public class VisitedPlacesAdapter extends RecyclerView.Adapter<VisitedPlacesAdapter.VisitedItemHolder> {
    ...
    public VisitedPlacesAdapter(Context context, List<FavoriteSetters> faves){
    ...
    @NonNull
    @Override
    public VisitedItemHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new VisitedItemHolder(layout);
    }

    @Override
    public void onBindViewHolder(VisitedItemHolder holder, int position) {
    ...
    class VisitedItemHolder extends RecyclerView.ViewHolder {

        TextView toursit_type, tourist_place;
        FloatingActionButton fabEditItemFavorite;
        String dbReference;

        public VisitedItemHolder(View itemView) {
            super(itemView);
